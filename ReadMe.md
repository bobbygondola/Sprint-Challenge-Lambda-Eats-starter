...
------It provides access to the match object. Its main use is to work around nested paths

2. How would you explain form validation to someone who has never programmed before?

-------Form validation makes it so the info you require from a form is the exact way you want it. ex. passwords with a min number of characters etc.

3. In 1-2 sentences, define end to end testing.

-------end to end testing is crucial in web dev because it runs through the program making sure everything works without ever touching the UI
